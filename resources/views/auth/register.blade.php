    ...
    <div class="register-box">
        ...
        <div class="card">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                @if(Session::has('team'))
                    <input type="hidden" name="team" value="{{ Session::get('team')->id }}">
                ...
                <div class="input-group mb-3">
                    <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ Session::get('email') ?? old('email') }}" placeholder="Email">
                    <div class="input-group-append">
                        <div class="input-group-text">
